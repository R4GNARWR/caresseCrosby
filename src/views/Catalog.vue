        ...
        <section class="catalog">
            <v-container>
                    ...
                    <v-col cols="12">
                        <div class="catalog__head">
                            ...
                            <div class="catalog__head-bottom">
                                <div class="catalog__head__filter-btn d-lg-none d-flex"
                                    @click="changeFilterVisibility()">
                                    <img src="/svg/filter.svg" alt="">
                                    Фильтры
                                </div>
                                <div class="catalog__head-select">
                                    <Dropdown :listItems="sortTypes" @items-action="sortCatalog">{{ activeSortString }}
                                    </Dropdown>
                                </div>
                            </div>
                        </div>
                ...
                <v-row>
                    ...
                    <v-col md="9" cols="12">
                        <CatalogList @update-catalog-height="updateCatalogHeight" :productArray="productsComputed"
